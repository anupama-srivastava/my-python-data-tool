...
def backtest_strategy(data):
    ...
    buy_hold_returns = data['Buy and Hold Returns'].dropna()
...
def plot_results(data, ticker):
    ...
    Args:
        data (pandas.DataFrame): The stock data with indicators and backtesting results.
        ticker (str): The stock symbol.
    """
    fig, (ax1, ax2, ax3) = plt.subplots(nrows=3, ncols=1, figsize=(14, 18), sharex=True, gridspec_kw={'height_ratios': [3, 1, 1]})
